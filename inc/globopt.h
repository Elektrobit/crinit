...
#ifdef ENABLE_CGROUP
    crinitCgroup_t
        *rootCgroup;  ///< Configuration for common crinit root cgroup that contains all sub-cgroups generated by crinit
    crinitCgroup_t **globCgroups;  ///< Global cgroup definitions that can be referenced by task files
    size_t globCgroupsCount;       ///< Count of elements in globCgroups.
#endif
