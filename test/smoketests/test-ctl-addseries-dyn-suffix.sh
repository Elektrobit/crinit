...
#
# smoketest for crinit-ctl addseries command (dynamic configuration, non-standard file suffix)
#
...
run() {
    ...
    # add a new series
    if ! "${BINDIR}"/crinit-ctl addseries "${SMOKETESTS_CONFDIR}"/addseries/demoadd_dyn_suffix.series; then
