...
const crinitConfigMapping_t crinitTaskCfgMap[] = {
    ...
    {CRINIT_CONFIG_GROUP, CRINIT_CONFIG_KEYSTR_GROUP, false, false, crinitCfgGroupHandler},
...
const crinitConfigMapping_t crinitSeriesCfgMap[] = {
    ...
    {CRINIT_CONFIG_ELOS_EVENT_POLL_INTERVAL, CRINIT_CONFIG_KEYSTR_ELOS_EVENT_POLL_INTERVAL, false, false, crinitCfgElosEventPollIntervalHandler},
